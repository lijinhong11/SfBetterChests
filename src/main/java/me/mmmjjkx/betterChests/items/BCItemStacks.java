...
public class BCItemStacks {
    ...
    public static final ItemStack CHEST_COLOR_CHANGER = new CustomItemStack(Material.STICK, "&aChest Color Changer", "&aRight-click to change the color of the BC chest", "&aShift + Right-click to cycle through colors", "", "&dCurrent color: &6NoColor", "", LoreBuilder.powerCharged(0, 200));
